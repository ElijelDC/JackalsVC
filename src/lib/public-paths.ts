...
export const PUBLIC_PATHS = {
  brand: {
    ...
    icon192: "/brand/icon-192.png?v=20260912c",
    icon512: "/brand/icon-512.png?v=20260912c",
    appleTouchIcon: "/brand/apple-touch-icon.png?v=20260912c",
  ...
  uploads: {
    ...
    trainingInviteProofs: "/uploads/training-invite-proofs",

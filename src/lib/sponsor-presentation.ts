...
export const PRESENTATION_VISION =
  "To compete strongly in Irish National League structures with squads built on homegrown talent, teamwork, and a culture where every member can train hard, play fierce, and win as a team.";

export const PRESENTATION_MISSION =
  "To promote volleyball at every level in a safe, fun, and competitive atmosphere — creating an environment where members improve their skills, support each other, and stay active through sport.";

export { SPONSOR_HERO_STATS as PRESENTATION_STATS };

export const PRESENTATION_PARTNER_BENEFITS = [
  "Increased exposure to our members, supporters, and the wider volleyball community in Ireland",
...
export const PRESENTATION_WHY_SPONSOR = [
  { label: "Social media & website", detail: "Logo placement, features, and promotion on jackalsvc.com and @jackalsvolleyball" },
...
export const PRESENTATION_INVESTMENT_AREAS = [
  {
    title: "Venue hire",
    detail:
      "Weekly training for our squads is essential for player development. Court time in Dublin is a major club cost — sponsorship helps keep volleyball accessible.",
  },
  {
    title: "Coaching & development",
    detail:
      "Qualified coaching at training and matches supports every squad, from league teams to newer players finding their level.",
  },
  {
    title: "Equipment",
    detail: "Nets, volleyballs, and training equipment needed across the season.",
  },
  {
    title: "Team kit & club uniform",
    detail: "Jerseys and kit that represent the club every week in league and tournament play.",
  },
];

export const PRESENTATION_SUPPORT_POINTS = [
  "Support competitive and social volleyball in Dublin",
  "Support a growing club with men's and women's squads and open community sessions",
  "Support diversity in sport — members across age groups and backgrounds united by the game",
];

export const PRESENTATION_CLOSING = {
  thanks:

...
import { CoachOfferAcceptForm } from "@/components/coach-offer/CoachOfferAcceptForm";
import { CoachOfferDeclineForm } from "@/components/coach-offer/CoachOfferDeclineForm";
...
export function CoachOfferExperience({ team }: { team: CoachOfferTeam }) {
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col items-center justify-center overflow-visible px-4 pb-4 pt-10 text-center sm:px-6">
          ...
          <AnimateIn immediate variant="fade-up" delay={340}>
            <p className="relative z-[1] pb-8 pt-2 text-center text-xs font-semibold uppercase tracking-[0.28em] text-zinc-500">
              ...
              Scroll for your coaching season
            </p>
          </AnimateIn>
        </div>
      </section>

      <ClubOfferBenefitsScroll
        team={team}
        sectionLabel={team.benefitsSectionLabel}
      />
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          <AnimateIn variant="pop-in">
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-zinc-400 sm:text-base">
              Confirm your Coach Offer for {team.shortName}, then complete your
      ...
      {panel ? (
        <section
          ref={formRef}
          id={panel === "accept" ? "accept-coach-offer" : "decline-coach-offer"}
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <AnimateIn variant="fade-up">
              ...
              <p className="mt-3 text-sm leading-relaxed text-zinc-400 sm:text-base">
                {panel === "accept"
                  ? team.formSupport
                  : `Tell us you won't be coaching ${team.shortName} this season.`}
              </p>
            </AnimateIn>
            <div className="relative mt-10">
              {panel === "accept" ? (
                <CoachOfferAcceptForm team={team} />
              ) : (
                <CoachOfferDeclineForm
                  team={team}
